...
const NOT_YET = '@parley/redis: not implemented yet (planned v0.3)';

/**
 * @parley/redis — first event-driven push backend (Redis Streams: XADD id = cursor, XRANGE = fetchRecent, XREAD BLOCK = subscribe).
 *
